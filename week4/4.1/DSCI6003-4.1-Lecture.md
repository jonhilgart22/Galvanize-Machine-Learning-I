...
![](http://bethycotter.wdfiles.com/local--files/non-linear-regression-in-ml/Screen%20Shot%202012-04-03%20at%2012.00.15%20PM.png)
...
How to predict with a decision tree is pretty clear: you just answer the questions and follow the path to the appropriate *leaf* node. But how do we build a decision tree? How do we determine which feature we should split on? This is the crux of the decision tree algorithm.
