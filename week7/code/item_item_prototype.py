...
items_cos_sim, neighborhoods = make_cos_sim_and_neighborhoods(ratings_mat, neighborhood_size=75)
user_1_preds = pred_one_user(items_cos_sim, neighborhoods, ratings_mat, 1)
